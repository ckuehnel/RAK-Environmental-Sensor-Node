...
uint8_t nodeDeviceEUI[8] = {0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x05, 0xB1, 0x22};
uint8_t nodeAppEUI[8] = {0xAC, 0x1F, 0x09, 0xFF, 0xFE, 0x06, 0x40, 0x41};
uint8_t nodeAppKey[16] = {0xE0, 0xE3, 0x47, 0xFF, 0x60, 0x45, 0x77, 0x23, 0xCC, 0x5D, 0x4B, 0xF8, 0x0F, 0xE8, 0xE3, 0x83};

// ABP keys (not used here)
