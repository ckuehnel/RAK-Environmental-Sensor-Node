/*
 * File: RAK11200_Sensors_BTSerial.ino
 * 
 ...
 * reads data from sensors and prepares it for serial output via Bluetooth Classic.
 * 
...
#include "BluetoothSerial.h"                // available already, no installation required

#define DEBUG 0
#define uS_TO_S_FACTOR 1000000ULL           // Conversion factor for micro seconds to seconds

static int64_t lastMeasurementTimeMs = 0;
static int IntervalinSeconds = 30;          // Measuring Interval 30 seconds
...
void setup() 
{
  ...
  Wire.begin();
  Serial.begin(115200);
  SerialBT.begin("RAK_Sensor");    // Name of BT device
  delay(1000);                    // wait for serial monitor
  Serial.println("BT ready. Pairing please...");  
...
void loop() 
{
  //if (millis() - lastMeasurementTimeMs >= IntervalinSeconds * uS_TO_S_FACTOR)
  {
